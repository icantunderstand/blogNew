...
- [Skills 的优点](#skills-的优点)
- [Skills 编写建议（通用模板）](#skills-编写建议通用模板)
- [Skills 使用（在通用 API 中模拟“技能包注入”）](#skills-使用在通用-api-中模拟技能包注入)
  - [示例代码（JavaScript）](#示例代码javascript)
- [Skills 和 MCP 对比](#skills和mcp对比)
  - [Skills（技能）](#skills技能)
  - [MCP（协议/连接层）](#mcp协议连接层)
