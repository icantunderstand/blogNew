...
| 502                     | 网关错误,表示网关或代理服务器从上游服务器接收到无效响应              |
...
| localStorage   | 存储在本地,长期有效存在同源策略                         |   5MB     | 不参与服务端通信 |
...
http1.1三种连接方式:
![http 1.1 三种连接模式](/static/images/javascriptBaseStatic/baseWebSummary/http.png)
...
![二进制分帧层](/static/images/javascriptBaseStatic/baseWebSummary/binaryFrameLayer.png)
